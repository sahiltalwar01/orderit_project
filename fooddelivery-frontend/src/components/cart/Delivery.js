            ...
            <div className='col-10 col-lg-5 cartt '>
                <form onSubmit={submitHandler}>
                    ...
                    <div className='form-group'>
                        ...
                        <input type="text" id='address_feild' className='form-control' value={address} onChange={(e)=>setAddress(e.target.value)} required></input>
                    </div>
                    <div className='form-group'>
                        <label htmlFor='city_field'
                        > City
                        </label>
                        <input type="text" id='city_feild' className='form-control' value={city} onChange={(e)=>setCity(e.target.value)} required></input>
                    </div>
                    <div className='form-group'>
                        <label htmlFor='phone_field'>
                        Phone Number
                        </label>
                        <input type="text" id='phone_feild' className='form-control' value={phoneNo} onChange={(e)=>setPhoneNo(e.target.value)} required></input>
                    </div>
                    <div className='form-group'>
                        <label htmlFor='postal_code_field'>
                        Postal Code
                        </label>
                        <input type="text" id='postal_code_feild' className='form-control' value={postalCode} onChange={(e)=>setPostalCode(e.target.value)} required></input>
                    </div>
                    <div className='form-group'>
                        <label htmlFor='country_field'>
                        Country
                        </label>
                        <select type="text" id='country_feild' className='form-control' value={country} onChange={(e)=>setCountry(e.target.value)} required>
